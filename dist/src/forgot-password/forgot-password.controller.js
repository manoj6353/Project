...
let ForgotPasswordController = class ForgotPasswordController {
    ...
    sendMailerPageUpdate(req, updatepassdto, res) {
        ...
        return this.forgotPasswordService.updatePassword(id, updatepassdto, res, tokens);
    }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, update_forgot_password_dto_1.UpdateForgotPasswordDto, Object]),
    __metadata("design:returntype", void 0)
