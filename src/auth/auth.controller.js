...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.getProfile = function (_a) {
        var accessToken = _a.accessToken, url = _a.url;
        return __awaiter(this, void 0, void 0, function () {
            var token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.authService.verifytoken(accessToken, url)];
                    case 1:
                        token = _b.sent();
                        return [2 /*return*/, 'manoj'];
                }
            });
        });
    };
