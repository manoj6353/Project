...
var AuthService = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        _a = {};
                        return [4 /*yield*/, this.jwtService.sign({ id: user.id })];
    ...
    AuthService.prototype.verifytoken = function (accessToken, url) {
        return __awaiter(this, void 0, void 0, function () {
            var isAdmin, id, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.jwtService.verify(accessToken)];
                    case 1:
                        id = (_a.sent()).id;
