...
var CategoryController = /** @class */ (function () {
    ...
    CategoryController.prototype.addcategory = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, { data: 'done' }];
            });
        });
    };
    CategoryController.prototype.add = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.categoryService.addCategory()];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.categoryService.create(createCategoryDto)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    CategoryController.prototype.root = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CategoryController.prototype.trash = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.categoryService.trash()];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, { data: data }];
                }
    ...
    CategoryController.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.categoryService.findOne(+id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    CategoryController.prototype.restore = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.categoryService.restore(+id)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ], CategoryController.prototype, "root");
    __decorate([
        (0, common_1.Get)('/trash'),
        (0, common_1.Render)('index')
    ], CategoryController.prototype, "trash");
    __decorate([
        (0, common_1.Get)(':id'),
    ...
    __decorate([
        ...
        __param(0, (0, common_1.Param)('id'))
    ], CategoryController.prototype, "restore");
