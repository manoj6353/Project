...
var CategoryService = /** @class */ (function () {
    ...
    CategoryService.prototype.create = function (createCategoryDto) {
        try {
            return prisma.categories.create({
                data: __assign({}, createCategoryDto)
            });
        }
        catch (err) {
            console.log(err);
    ...
    CategoryService.prototype.update = function (id, updateCategoryDto) {
        return prisma.categories.update(__assign({ where: { id: id } }, updateCategoryDto));
    };
    ...
    CategoryService.prototype.trash = function () {
        try {
    ...
    CategoryService.prototype.restore = function (id) {
        try {
            return prisma.categories.update({
                where: { id: id },
                data: {
