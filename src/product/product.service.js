...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.create = function (createProductDto, file) {
        return __awaiter(this, void 0, void 0, function () {
            var id, subId, data, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = parseInt(createProductDto.categoryId);
                        subId = parseInt(createProductDto.subCategoryId);
    ...
    ProductService.prototype.fetchsubcategory = function (id) {
        try {
    ...
    ProductService.prototype.findsearch = function (productName) {
        try {
            return prisma.products.findMany({
                where: {
                    productName: {
    ...
    ProductService.prototype.update = function (id, updateProductDto) {
        try {
            var id_1 = parseInt(updateProductDto.categoryId);
    ...
    ProductService.prototype.restore = function (id) {
        try {
